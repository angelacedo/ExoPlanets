...
const DashBoard: React.FC<Props> = ({topCardsValues, exoplanetsByMonth, lastestExoplanets, actualDate}) =>
{
    return (
        <div className='my-3 mx-5'>
            <section className="flex flex-wrap sm:flex-row sm:flex-nowrap justify-center items-center lg:max-w-[1200px] lg:m-auto">
            ...
            <section>
                <div className='flex flex-wrap sm:flex-row justify-center items-center lg:max-w-[1200px] mx-auto my-3'>
